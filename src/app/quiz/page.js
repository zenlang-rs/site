  ...
  return (
    ...
    >
      <div className="w-1/2 p-4  overflow-auto h-screen text-lg">
        ...
        <p>1 ≤ X ≤ 4000</p>
        <br/>
        <h2 className="text-2xl font-bold mt-4 mb-4">SAMPLE INPUT AND OUTPUT</h2>
      ...
      <div className="w-1/2 flex flex-col h-screen">
        ...
        <section className={darkMode ? 'sticky bottom-0 bg-black ml-6' : 'sticky bottom-0 bg-white ml-6'}>
          <h1
            className={
              darkMode
      ...
      <div className="fixed bottom-4 right-4 space-x-4">
        ...
        <button className="bg-blue-500 text-white px-4 py-2 rounded-lg">Compile</button>
      </div>
    </div>
  )
